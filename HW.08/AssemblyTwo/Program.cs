...
namespace AssemblyTwo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //                    from Motorcycle and because of class Program doesn't basic class where method declared. and finally
            //                    StartEngine declared in another assembly(AssemblyOne)
